...
"""
    % {"magic_size": MAGIC_SIZE, "sync_size": SYNC_SIZE}
)
...
class DataFileWriter(object):
    ...
    def __init__(self, writer, datum_writer, writer_schema=None, codec="null"):
    ...
    """
        ...
        assert isinstance(value, bytes), "Invalid metadata value for key %r: %r" % (
            key,
            value,
        )
